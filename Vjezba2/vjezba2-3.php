...
$autor  = "Jakša Mencl";
$opis   = "Ova stranica nadograđuje vježbu 2-2: biramo temu (dark/light), odabiremo sliku i po želji prikazujemo opis.";
...
<head>
  ...
  <meta name="description" content="Vježba 2-3 — forma (GET), izbor teme i slike, osnovni CSS.">
