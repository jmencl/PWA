...
if (!empty($_COOKIE['news_title_1']) || 
    !empty($_COOKIE['news_title_2']) || 
    !empty($_COOKIE['news_title_3'])) {
    ...
    if (!empty($_COOKIE['news_title_1'])) {
        print '<p>
        <a href="' . $_COOKIE['news_link_1'] . '">
        ' . $_COOKIE['news_title_1'] . '
        </a>
        </p>';
    }
    ...
    if (!empty($_COOKIE['news_title_2'])) {
        print '<p>
        <a href="' . $_COOKIE['news_link_2'] . '">
        ' . $_COOKIE['news_title_2'] . '
        </a>
        </p>';
    }
    ...
    if (!empty($_COOKIE['news_title_3'])) {
        print '<p>
        <a href="' . $_COOKIE['news_link_3'] . '">
        ' . $_COOKIE['news_title_3'] . '
        </a>
        </p>';
    }
